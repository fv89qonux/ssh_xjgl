...
<div style="padding: 15px 25px 15px 15px; width: 60%;margin: 0 auto" >
	...
	private String phone;// 校医院联系方式 -->
             <tr>
                ...
                <td width="">
                  <input type="text" name="sg" value="${Obj.sg }">单位：cm
                </td>
                <td width="20%" bgcolor="#EBEBEB">体重：</td>
                <td>
                 <input type="text" name="tz" value="${Obj.tz }">单位：kg
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="">
                  <input type="text" name="xy" value="${Obj.xy }">
                </td>
                <td width="20%" bgcolor="#EBEBEB">血型：</td>
                <td>
                 <input type="text" name="xx" value="${Obj.xx }">
                </td>
            </tr>
             <tr>
                <td width="20%" bgcolor="#EBEBEB">肺活量：</td>
                <td width="">
                  <input type="text" name="fhl" value="${Obj.fhl }">
                </td>
