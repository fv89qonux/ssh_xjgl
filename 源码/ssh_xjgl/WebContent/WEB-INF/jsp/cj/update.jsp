...
<div style="">
<form id="myFormId" action="cj_exUpdate.do" method="post">
    ...
    <table class="if_tableview_form" style=" ">
     <tr>
            <td width="90" align="right"><span class="star">*</span>学号：</td>
            <td width="270">
                ${user.userName }</td>
        </tr>
         <tr>
            <td width="90" align="right"><span class="star">*</span>姓名：</td>
            <td width="270">
                ${user.realName }</td>
        </tr>
        <tr>
            <td align="right">得分：</td>
            <td ><input type="text" name="df" value="${cj.df}"/></td>
        </tr>
        </tr>
    </table>
</form>
