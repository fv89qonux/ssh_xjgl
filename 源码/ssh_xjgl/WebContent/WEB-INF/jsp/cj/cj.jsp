...
<div id="scrollContent" style="overflow-x:hidden;">
	...
	private String name; -->
	       <tr>
                ...
                <td align="center" title="">${data.user.realName}</td>
                <td align="center" title="">${teacher.xk.code}</td>
                <td align="center">${teacher.xk.name}</td>
                 <td align="center">
                  <c:if test="${data.cj.df == null}">
                    未录入
                  </c:if>
                  <c:if test="${data.cj.df != null}">
                    ${data.cj.df}
                ...
                <td align="center" style="margin-right: 3px">
                 <a href="cj_update.do?uid=${data.user.id}&xq=${Obj.xq}" > <span style="color: red">成绩操作</span></a>
                </td>
            </tr>
             </c:forEach>
