...
<body>
<div class="box2" panelTitle="教师查询" id="searchPanel">
    <form action="teacher_teacher.do" id="queryForm" method="post">
        <table class="if_search_table">
            <tr>
                <td align="right" class="if_w80">教师名称：</td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right5" style="margin-bottom: 0px; ">
        <a href="teacher_add.do" style="display: block; width: 77px; height: 28px; background-color: #3ba2c0;
...
<div style="height:35px; width: 400px;margin: 0 auto">
    <pg:pager  url="${ctx}/teacher_teacher.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
		<pg:last>  
   ...
   function postData() {
    ...
    function del(id){
    	top.Dialog.confirm("是否确认删除",function(){
    		location.href=ctx+"/teacher_delete.do?id="+id;
    	},function(){
