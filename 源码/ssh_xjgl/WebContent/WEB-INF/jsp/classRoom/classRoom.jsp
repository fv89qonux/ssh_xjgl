...
<div class="box2" panelTitle="班级查询" id="searchPanel">
    <form action="classRoom_classRoom.do" id="queryForm" method="post">
	...
	private String name; -->
	       <tr>
                ...
                <td align="center" style="margin-right: 3px">
                 <a href="classRoom_update.do?id=${data.id}"> <span style="color: #f9a002" >修改</span></a>
                 <a href="javascript:" onclick="del('${data.id}')"> <span style="color: red">删除</span></a>
                 <a href="user_classUser.do?cid=${data.id}" > <span style="color: red">查看学生</span></a>
                </td>
            </tr>
             </c:forEach>
