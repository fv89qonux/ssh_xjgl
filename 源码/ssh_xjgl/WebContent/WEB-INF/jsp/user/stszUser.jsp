...
<div class="box2" panelTitle="学生查询" id="searchPanel">
    <form action="user_stszUser.do" id="queryForm" method="post">
	...
	private String name; -->
	       <tr>
                ...
                <td align="center" style="margin-right: 3px">
                 <a href="stsz_update.do?uid=${data.id}"> <span style="color: red">身体素质管理</span></a>
                 <a href="javascript:" onclick="detail('${data.id}')"> <span style="color: red">查看学籍信息</span></a>
                </td>
            </tr>
             </c:forEach>
...
<div style="height:35px; width: 400px;margin: 0 auto">
    <pg:pager  url="${ctx}/user_stszUser.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
		<pg:last>  
