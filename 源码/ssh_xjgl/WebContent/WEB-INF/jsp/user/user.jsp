...
<div class="box2" panelTitle="学生查询" id="searchPanel">
    <form action="user_user.do" id="queryForm" method="post">
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right5" style="margin-bottom: 0px; ">
        <a href="user_add.do" style="display: block; width: 77px; height: 28px; background-color: #3ba2c0;
        ...
        <a href="user_export.do" style="display: block; width: 77px; height: 28px; background-color: #3ba2c0;
        text-align: center; color: white; line-height: 28px; text-decoration:none; font-size: 13px; margin-bottom: -10px; margin-right: 10px">导出</a>
 </div>
	...
	private String name; -->
	       <tr>
                ...
                <td align="center" style="margin-right: 3px">
                 <a href="user_update.do?id=${data.id}"> <span style="color: #f9a002" >修改</span></a>
